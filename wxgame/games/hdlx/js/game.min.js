...
arguments);this._super=c;return d}}(q,n[q]),Object.defineProperty(f,q,h)):r?(h.value=n[q],Object.defineProperty(f,q,h)):f[q]=n[q];if(r){var u,v;if(this.__getters__&&this.__getters__[q]){var r=this.__getters__[q],w;for(w in this.__setters__)if(this.__setters__[w]==r){v=w;break}cc.defineGetterSetter(f,r,n[q],n[v]?n[v]:f[v],q,v)}if(this.__setters__&&this.__setters__[q]){r=this.__setters__[q];for(w in this.__getters__)if(this.__getters__[w]==r){u=w;break}cc.defineGetterSetter(f,r,n[u]?n[u]:f[u],n[q],
...
cc.kmMat4Multiply=function(a,b,c){var d=a.mat,e=b.mat[0],f=b.mat[1],g=b.mat[2],h=b.mat[3],k=b.mat[4],m=b.mat[5],n=b.mat[6],q=b.mat[7],r=b.mat[8],s=b.mat[9],t=b.mat[10],u=b.mat[11],v=b.mat[12],w=b.mat[13],x=b.mat[14];b=b.mat[15];var y=c.mat[0],z=c.mat[1],A=c.mat[2],B=c.mat[3],C=c.mat[4],D=c.mat[5],E=c.mat[6],F=c.mat[7],G=c.mat[8],H=c.mat[9],I=c.mat[10],J=c.mat[11],K=c.mat[12],L=c.mat[13],M=c.mat[14];c=c.mat[15];d[0]=y*e+z*k+A*r+B*v;d[1]=y*f+z*m+A*s+B*w;d[2]=y*g+z*n+A*t+B*x;d[3]=y*h+z*q+A*u+B*b;d[4]=
C*e+D*k+E*r+F*v;d[5]=C*f+D*m+E*s+F*w;d[6]=C*g+D*n+E*t+F*x;d[7]=C*h+D*q+E*u+F*b;d[8]=G*e+H*k+I*r+J*v;d[9]=G*f+H*m+I*s+J*w;d[10]=G*g+H*n+I*t+J*x;d[11]=G*h+H*q+I*u+J*b;d[12]=K*e+L*k+M*r+c*v;d[13]=K*f+L*m+M*s+c*w;d[14]=K*g+L*n+M*t+c*x;d[15]=K*h+L*q+M*u+c*b;return a};
...
!0),!0):!1},createFontChars:function(){var a=cc._renderType,b=a===cc._RENDER_TYPE_CANVAS?this.texture:this.textureAtlas.texture,c=0,d=cc.size(0,0),e=0,f=1,g=this._string,h=g?g.length:0;if(0!==h){var k,m=this._config,n=m.kerningDict,q=m.commonHeight,r=m.fontDefDictionary;for(k=0;k<h-1;k++)10==g.charCodeAt(k)&&f++;var s=q*f,f=-(q-q*f),t=-1;for(k=0;k<h;k++)if(q=g.charCodeAt(k),0!=q)if(10===q)c=0,f-=m.commonHeight;else{var u=n[t<<16|q&65535]||0,v=r[q];if(v){var w=cc.rect(v.rect.x,v.rect.y,v.rect.width,
...
!0)},updateLabel:function(){this.string=this._initialString;if(0<this._width){for(var a=this._string.length,b=[],c=[],d=1,e=0,f=!1,g=!1,h=-1,k=-1,m=0,n,q=0,r=this._children.length;q<r;q++){for(var s=0;!(n=this.getChildByTag(q+m+s));)s++;m+=s;if(e>=a)break;var t=this._string[e];g||(k=this._getLetterPosXLeft(n),g=!0);f||(h=k,f=!0);if(10==t.charCodeAt(0)){c.push("\n");b=b.concat(c);c.length=0;f=g=!1;h=k=-1;q--;m-=s;d++;if(e>=a)break;k||(k=this._getLetterPosXLeft(n),g=!0);h||(h=k,f=!0);e++}else if(this._isspace_unicode(t))c.push(t),
...
cc.Menu.create=function(a){var b=arguments.length;0<b&&null==arguments[b-1]&&cc.log("parameters should not be ending with null in Javascript");return 0==b?new cc.Menu:1==b?new cc.Menu(a):new cc.Menu(Array.prototype.slice.call(arguments,0))};var res={data_img_01_plist:"res/data_img_01.plist",data_img_01_png:"res/data_img_01.png",bg_png:"res/bg.png",aboutMenu_png:"res/aboutMenu.png",startMenu_png:"res/startMenu.png",number_fnt:"res/number.fnt",number_0_png:"res/number_0.png",fenxiang:"res/fenxiang.png",chongxinkaishi:"res/chongxinkaishi.png",uis_1:"res/uis_1.png",uis_2:"res/uis_2.png",uis_3:"res/uis_3.png",help3:"res/help3.png",share:"res/share.png"},g_resources=[],i;for(i in res)g_resources.push(res[i]);
var configs={cScal:1,mWidth:400,mHeight:630,fishArray:[],_sOffset:1,_bOffset:1};var spriteFrameCache=cc.spriteFrameCache,self,initFirst=!0,mainlayer,successLayer,gameOver=!1,isFenTest=!0,s_spawn_time_const=3,b_spawn_time_const=5,s_spawn_time=0,b_spawn_time=b_spawn_time_const,sFishArray=[],bFishArray=[],thisPoint=null,cuurentFish=null,score=0,wangScore=0,isWang=!1,spriteTag=2E6,isTouch=!1,isSns=!1,HelloWorldLayer=cc.Layer.extend({ctor:function(){this._super();this.initData();this.startBg();self=this;this.initSns();return!0},initSns:function(){},setVisi:function(){},snsCancel:function(){},snsFail:function(){},snsConfirm:function(){isSns&&mainlayer.fuhuo()},initData:function(){cc.spriteFrameCache.addSpriteFrames("res/data_img_01.plist");self=this},startBg:function(){var a=new cc.Sprite("res/startbg.png");a.attr({x:configs.mWidth/2,y:configs.mHeight/2,anchorX:0.5,anchorY:0.5});this.addChild(a,0,5060);a=new cc.Sprite("res/by.png");
a.attr({x:configs.mWidth/2,y:configs.mHeight/2,scale:configs.cScal,anchorX:0.5,anchorY:0.5});this.addChild(a,100003,7010);a.visible=!1;this.menu=new cc.Menu;this.menu.x=0;this.menu.y=0;this.addChild(this.menu,100001);a=new cc.MenuItemImage("res/startMenu.png","res/startMenu.png",function(){var a=this.getChildByTag(7010);null!=a&&a.visible?a.visible=!1:(this.removeChildByTag(5060,!0),this.removeChildByTag(7010,!0),this.menu.removeChildByTag(5050,!0),this.menu.removeChildByTag(5049,!0),isFenTest=!1,
mainlayer.firstStartGame())},this);a.attr({x:configs.mWidth/2-150,y:configs.mHeight/2-180,anchorX:0,anchorY:0});this.menu.addChild(a,10,5050);a=new cc.MenuItemImage("res/aboutMenu.png","res/aboutMenu.png",function(){clickMore();},this);a.attr({x:configs.mWidth-55,y:configs.mHeight/2-180,anchorX:1,anchorY:0});this.menu.addChild(a,10,5049)},update:function(a){if(!gameOver&&!isTouch){for(var b=0;b<configs.fishArray.length;b++){var c=configs.fishArray[b];
if(c.active){if(1==c.types){var d=cc.rectContainsPoint(this.sfishrect(),cc.p(c.x,c.y));if(d){c.destroy();mainlayer.updateScore(1);0==score%60&&mainlayer.wangFish(0);continue}}else if(2==c.types&&(d=cc.rectIntersectsRect(c.collideRect(),mainlayer.bfishrect()))){c.setEndPoint(cc.p(cuurentFish.x,cuurentFish.y));c.setOffset2();a=new cc.Sequence(new cc.DelayTime(1),new cc.CallFunc(mainlayer.gameFinsh,this,0));this.runAction(a);gameOver=!0;return}1==c.types&&2!=c.moveType?(d=this.fishrect(),(d=cc.rectContainsPoint(d,
cc.p(c.x,c.y)))&&c.updateMoveType(cc.p(cuurentFish.x,cuurentFish.y))):2==c.types&&2!=c.moveType&&0<c.x&&c.x<configs.mWidth&&0<c.y&&c.y<configs.mHeight&&(d=this.fishrect(),(d=cc.rectContainsPoint(d,cc.p(c.x,c.y)))&&c.updateMoveType2(cc.p(cuurentFish.x,cuurentFish.y)))}}mainlayer.spawn(a)}},gameFinsh:function(){gameOver=!0;mainlayer.startLayer()},fishrect:function(){return cc.rect(cuurentFish.x-100,cuurentFish.y-100,200,200)},sfishrect:function(){return cc.rect(cuurentFish.x-40,cuurentFish.y-40,80,
80)},bfishrect:function(){return cc.rect(cuurentFish.x-30,cuurentFish.y-30,60,60)},firstStartGame:function(){var a=new cc.Sprite("res/bg.png");a.attr({x:configs.mWidth/2,y:configs.mHeight/2,anchorX:0.5,anchorY:0.5});this.addChild(a,0,5060);a=new cc.LabelTTF("\u6355\u5c0f\u9c7c:","\u5b8b\u4f53",22,cc.size(110,30),cc.TEXT_ALIGNMENT_LEFT);a.x=35;a.y=configs.mHeight-40;a.anchorY=0.5;a.anchorX=0;this.addChild(a);a=new cc.LabelBMFont("0","res/number.fnt");a.anchorX=0;a.anchorY=0.5;a.x=115;a.y=configs.mHeight-
37;mainlayer.addChild(a,1,9E3);a=new cc.LabelTTF("\u6355\u5927\u9c7c:","\u5b8b\u4f53",22,cc.size(110,30),cc.TEXT_ALIGNMENT_LEFT);a.x=250;a.y=configs.mHeight-40;a.anchorY=0.5;a.anchorX=0;this.addChild(a);a=new cc.LabelBMFont("0","res/number.fnt");a.anchorX=0;a.anchorY=0.5;a.x=330;a.y=configs.mHeight-37;mainlayer.addChild(a,1,9001);cuurentFish=Fish.create(3,0.5*configs.mWidth,0.5*configs.mHeight,0.5*configs.mWidth,0.5*configs.mHeight);cuurentFish.setOffset(20);isTouch=!0;mainlayer.startGameAmin();a=
new cc.Sprite("res/help3.png");a.attr({x:configs.mWidth/2,y:configs.mHeight/2,anchorX:0.5,anchorY:0.5});this.addChild(a,1E3,7E3);score=0;mainlayer.updateScore(0);b_spawn_time=s_spawn_time=0},startGameAmin:function(){var a=mainlayer.createSprite2(0.5*cc.winSize.width,cc.winSize.height,0.5,0.5,"res/uis_3.png",4430,1E4),b=cc.Sequence.create(new cc.EaseSineOut(new cc.MoveTo.create(0.2,cc.p(0.5*cc.winSize.width,0.5*cc.winSize.height))),new cc.FadeTo(1.2,0),new cc.CallFunc(mainlayer.startGameAmin2,a,0));
a.runAction(b)},startGameAmin2:function(){mainlayer.removeChildByTag(4430,!0);var a=mainlayer.createSprite2(0.5*cc.winSize.width,cc.winSize.height,0.5,0.5,"res/uis_2.png",4430,1E3),b=cc.Sequence.create(new cc.EaseSineOut(cc.MoveTo.create(0.2,cc.p(0.5*cc.winSize.width,0.5*cc.winSize.height))),cc.FadeTo.create(1,0),cc.CallFunc.create(mainlayer.startGameAmin3,a,0));a.runAction(b)},startGameAmin3:function(){mainlayer.removeChildByTag(4430,!0);var a=mainlayer.createSprite2(0.5*cc.winSize.width,cc.winSize.height,
0.5,0.5,"res/uis_1.png",4430,1E3),b=cc.Sequence.create(new cc.EaseSineOut(cc.MoveTo.create(0.2,cc.p(0.5*cc.winSize.width,0.5*cc.winSize.height))),cc.FadeTo.create(1,0),cc.CallFunc.create(mainlayer.updateGame,a,0));a.runAction(b)},updateGame:function(){mainlayer.removeChildByTag(7E3,!0);isTouch=!1;mainlayer.scheduleUpdate()},updateScore:function(a){score+=a;a=mainlayer.getChildByTag(9E3);null!=a&&a.setString(score.toString())},updateScore2:function(a){wangScore+=a;a=mainlayer.getChildByTag(9001);null!=
a&&a.setString(wangScore.toString())},spawn:function(a){s_spawn_time-=a;if(0>=s_spawn_time){for(var b=0,c=0;c<configs.fishArray.length;c++){var d=configs.fishArray[c];d.active&&1==d.types&&b++}30<b?b=30:this.s_spawn();s_spawn_time=1/(2*(31-b))}b_spawn_time-=a;0>=b_spawn_time&&(b_spawn_time=b_spawn_time_const,this.b_spawn())},s_spawn:function(){var a=Math.round(3*cc.random0To1())+1;if(1==a){var a=-50,b=Math.round(cc.random0To1()*(configs.mHeight-20))+10;Fish.create(1,a,b,a,b)}else 2==a?(a=Math.round(cc.random0To1()*
(configs.mWidth-20))+10,b=-50,Fish.create(1,a,b,a,b)):3==a?(a=configs.mWidth+50,b=Math.round(cc.random0To1()*(configs.mHeight-20))+10,Fish.create(1,a,b,a,b)):4==a&&(a=Math.round(cc.random0To1()*(configs.mWidth-20))+10,b=configs.mHeight+50,Fish.create(1,a,b,a,b))},warningAction:function(a,b){var c=spriteTag++,d=new cc.Sprite(spriteFrameCache.getSpriteFrame("warning.png"));d.attr({x:a,y:b,anchorX:0.5,anchorY:0.5});mainlayer.addChild(d,5E4,c);var e=new cc.FadeTo(0.7,0),f=new cc.FadeTo(0.2,255),g=new cc.FadeTo(0.7,
0),h=new cc.FadeTo(0.2,255),c=new cc.Sequence(e,f,g,h,new cc.CallFunc(mainlayer.removeSprite,d,c));d.runAction(c)},b_spawn:function(){var a=Math.round(3*cc.random0To1())+1;if(1==a){var a=-70,b=Math.round(cc.random0To1()*(configs.mHeight-20))+10,c=0;Fish.create(2,a,b,c,b);mainlayer.warningAction(c,b)}else 2==a?(a=Math.round(cc.random0To1()*(configs.mWidth-20))+10,c=0,Fish.create(2,a,-70,a,c),mainlayer.warningAction(a,c)):3==a?(a=configs.mWidth+70,b=Math.round(cc.random0To1()*(configs.mHeight-20))+
10,c=configs.mWidth,Fish.create(2,a,b,c,b),mainlayer.warningAction(c,b)):4==a&&(a=Math.round(cc.random0To1()*(configs.mWidth-20))+10,b=configs.mHeight+70,c=configs.mHeight,Fish.create(2,a,b,a,c),mainlayer.warningAction(a,c))},onEnter:function(){this._super();cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,onTouchBegan:function(a,b){if(gameOver||isTouch)return!1;if(isFenTest){var c=mainlayer.getChildByTag(7010);if(null!=c)return c.visible=!1}a.getLocation();return!0},onTouchMoved:function(a,
b){if(!gameOver&&!isTouch){var c=a.getLocation();cuurentFish.setEndPoint(c)}},onTouchEnded:function(a,b){if(!gameOver&&!isTouch){var c=a.getLocation();cuurentFish.setEndPoint(c)}}},this)},wangFish:function(a){mainlayer.updateScore2(1);for(a=0;a<configs.fishArray.length;a++){var b=configs.fishArray[a];b.active&&2==b.types&&b.destroy()}isWang=!1},removeSprite:function(a,b){mainlayer.removeChildByTag(b)},closeLayer:function(){isSns=!1;successLayer.runAction(cc.Sequence.create(cc.FadeTo.create(0.1,0),
cc.MoveTo.create(0.2,cc.p(0,0-configs.mHeight))))},startLayer:function(a){isSns=!0;successLayer.visible=!0;successLayer.addLabel();successLayer.y=configs.mHeight;successLayer.runAction(cc.Sequence.create(new cc.EaseSineOut(new cc.MoveTo(0.2,cc.p(0,0))),new cc.FadeTo(0.2,140)))},createSprite2:function(a,b,c,d,e,f,g){e=new cc.Sprite(e);e.attr({x:a,y:b,anchorX:c,anchorY:d});mainlayer.addChild(e,g,f);return e},fuhuo:function(){mainlayer.unschedule(this.scheduleUpdate);for(var a=configs.fishArray.length,
b=0;b<a;b++)mainlayer.removeChild(configs.fishArray[b],!0);configs.fishArray.splice(0,a);mainlayer.removeChild(cuurentFish,!0);cuurentFish=Fish.create(3,0.5*configs.mWidth,0.5*configs.mHeight,0.5*configs.mWidth,0.5*configs.mHeight);cuurentFish.setOffset(20);gameOver=!1;isTouch=!0;mainlayer.startGameAmin();a=new cc.Sprite("res/help3.png");a.attr({x:configs.mWidth/2,y:configs.mHeight/2,anchorX:0.5,anchorY:0.5});this.addChild(a,1E3,7E3);mainlayer.closeLayer()},chongxinkaishi:function(){mainlayer.unschedule(this.scheduleUpdate);
for(var a=configs.fishArray.length,b=0;b<a;b++)mainlayer.removeChild(configs.fishArray[b],!0);configs.fishArray.splice(0,a);mainlayer.removeChild(cuurentFish,!0);cuurentFish=Fish.create(3,0.5*configs.mWidth,0.5*configs.mHeight,0.5*configs.mWidth,0.5*configs.mHeight);cuurentFish.setOffset(20);gameOver=!1;isTouch=!0;mainlayer.startGameAmin();a=new cc.Sprite("res/help3.png");a.attr({x:configs.mWidth/2,y:configs.mHeight/2,anchorX:0.5,anchorY:0.5});this.addChild(a,1E3,7E3);mainlayer.closeLayer();score=
0;mainlayer.updateScore(0);b_spawn_time=s_spawn_time=0}}),isXuanyao=!1,SuccessUI=cc.Layer.extend({losePanel:null,label:null,closeItem1:null,closeItem2:null,ctor:function(){this._super();this.losePanel=new cc.Sprite("res/data_img_04.png");this.losePanel.x=cc.winSize.width/2;this.losePanel.anchorY=0.2;this.losePanel.y=cc.winSize.height/2;this.addChild(this.losePanel);var a=this.losePanel.x+164,b=this.losePanel.y-35;this.closeItem1=cc.MenuItemImage.create("res/fenxiang.png","res/fenxiang.png",function(){showshare();},this);this.closeItem1.attr({x:a,y:b,anchorX:1,anchorY:0});var c=cc.Menu.create(this.closeItem1);c.x=0;c.y=0;this.addChild(c,1);a=this.losePanel.x-174;this.closeItem2=cc.MenuItemImage.create("res/chongxinkaishi.png","res/chongxinkaishi.png",function(){successLayer.visiXuanyao()||
mainlayer.chongxinkaishi()},this);this.closeItem2.attr({x:a,y:b,anchorX:0,anchorY:0});c.addChild(this.closeItem2)},onEnter:function(){this._super();cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,onTouchBegan:function(a,b){successLayer.visiXuanyao();return!1},onTouchMoved:function(a,b){},onTouchEnded:function(a,b){}},this)},onExit:function(){this._super()},addLabel:function(){null!=this.label&&this.removeChild(this.label,!0);var stitle="";if(score<30){stitle="捕鱼新人";}else if(score<60){stitle="捕鱼初学者";}else if(score<100){stitle="捕鱼专业户";}else if(score<200){stitle="捕鱼高手";}else if(score<300){stitle="捕鱼专家";}else if(score<500){stitle="捕鱼精英";}else if(score<700){stitle="捕鱼大师";}else if(score<1000){stitle="捕鱼宗师";}else{stitle="捕鱼大亨";}var num=parseInt(Math.random()*50);var a="\u795d\u8d3a\u4f60\u6355\u6349\u5230"+score+
"\u6761\u9c7c,号称\""+stitle+"\",离下一个称号还差"+num+"条,快分享给小伙伴试试！";dp_submitScore(-1,score);dp_share(score,stitle);this.label=new cc.LabelTTF(a,"\u5b8b\u4f53",22,cc.size(0.8*cc.winSize.width,270),cc.TEXT_ALIGNMENT_CENTER);this.label.x=this.losePanel.x;this.label.y=this.losePanel.y-5;this.label.anchorY=0.5;this.label.color=cc.color(250,120,5);this.addChild(this.label)},
visiXuanyao:function(){return isXuanyao?(isXuanyao=!1,successLayer.removeChildByTag(70812,!0),!0):!1}}),HelloWorldScene=cc.Scene.extend({onEnter:function(){this._super();mainlayer=new HelloWorldLayer;this.addChild(mainlayer);successLayer=new SuccessUI;this.addChild(successLayer,1E4,3002);successLayer.visible=!1}});var Fish=cc.Sprite.extend({active:!0,velocity:1,endPoint:null,types:0,_offset:1,moveType:1,fishGameOver:!1,ctor:function(a,b,c,d,e,f){this._super("#"+b);this.x=c;this.y=d;this.endPoint=cc.p(e,f);this.types=a;this._offset=Math.round(1*cc.random0To1())+1;this.anchorX=0.5;2==a&&(this.anchorX=0.8,this._offset=cc.random0To1()+0.5);this.anchorY=0.5;this.scheduleUpdate()},update:function(a){this.fishGameOver||this.moveToPoint()},destroy:function(){this.visible=this.active=!1},collideRect:function(){if(1==
this.types)return cc.rect(this.x-40,this.y-20,80,80);if(2==this.types)return cc.rect(this.x-20,this.y-20,40,40)},setEndPoint:function(a){this.endPoint=a},setOffset:function(a){this._offset=a},setOffset2:function(){this._offset*=3},setPoint:function(a){this.x=a.x;this.y=a.y},updateMoveType:function(a){if(a.x<=this.x&&a.y>=this.y){var b=a.x+100+Math.round(50*cc.random0To1());a=a.y-100-Math.round(50*cc.random0To1());b>configs.mWidth&&(b=configs.mWidth);0>a&&(a=0);this.setEndPoint(cc.p(b,a));this.moveType=
2;this._offset*=2}else a.x>=this.x&&a.y>=this.y?(b=a.x-100-Math.round(50*cc.random0To1()),a=a.y-100-Math.round(50*cc.random0To1()),0>b&&(b=0),0>a&&(a=0),this.setEndPoint(cc.p(b,a)),this.moveType=2,this._offset*=2):a.x<=this.x&&a.y<=this.y?(b=a.x+100+Math.round(50*cc.random0To1()),a=a.y+100+Math.round(50*cc.random0To1()),b>configs.mWidth&&(b=configs.mWidth),a>configs.mHeight&&(a=configs.mHeight),this.setEndPoint(cc.p(b,a)),this.moveType=2,this._offset*=2):a.x>=this.x&&a.y<=this.y&&(b=a.x-100-Math.round(50*
cc.random0To1()),a=a.y+100+Math.round(50*cc.random0To1()),0>b&&(b=0),a>configs.mHeight&&(a=configs.mHeight),this.setEndPoint(cc.p(b,a)),this.moveType=2,this._offset*=2)},updateMoveType2:function(a){this.setEndPoint(a);this.moveType=2;this._offset*=2},moveToPoint:function(){if(this.x<=this.endPoint.x+this._offset&&this.x>=this.endPoint.x-this._offset&&this.y<=this.endPoint.y+this._offset&&this.y>=this.endPoint.y-this._offset)gameOver&&(this.fishGameOver=!0),3!=this.types&&(2==this.moveType&&(this._offset*=
0.5,this.moveType=1),this.nextEndPoint());else{var a=this.endPoint.x-this.x,b=this.endPoint.y-this.y,c=Math.atan(Math.abs(b/a)),d=Math.cos(c)*this._offset,c=Math.sin(c)*this._offset,d=0<a?Math.abs(d):-Math.abs(d),c=0<b?Math.abs(c):-Math.abs(c);this.rotation=this.getAngle(cc.p(this.x,this.y),this.endPoint);this.x+=d;this.y+=c}},getAngle:function(a,b){if(b.x>a.x){if(a.y==b.y)return 0;if(b.y>a.y){var c=b.x-a.x,d=b.y-a.y,c=Math.atan(d/c);return 180*-c/3.1415}c=b.x-a.x;d=a.y-b.y;c=Math.atan(d/c);return 180*
c/3.1415}if(b.x<a.x){if(a.y==b.y)return 180;if(b.y>a.y)return c=a.x-b.x,d=b.y-a.y,c=Math.atan(d/c),180+180*c/3.1415;c=a.x-b.x;d=a.y-b.y;c=Math.atan(d/c);return-180-180*c/3.1415}return a.y==b.y?-90:b.y>a.y?-90:90},nextEndPoint:function(){var a=Math.round(3*cc.random0To1())+1;if(1==a){var a=Math.round(cc.random0To1()*configs.mWidth*0.5)+1,b=Math.round(cc.random0To1()*configs.mHeight*0.5)+1;this.setEndPoint(cc.p(a,b))}else 2==a?(a=Math.round(cc.random0To1()*configs.mWidth*0.5)+0.5*configs.mWidth,b=Math.round(cc.random0To1()*
configs.mHeight*0.5)+1,this.setEndPoint(cc.p(a,b))):3==a?(a=Math.round(cc.random0To1()*configs.mWidth*0.5)+0.5*configs.mWidth,b=Math.round(cc.random0To1()*configs.mHeight*0.5)+0.5*configs.mHeight,this.setEndPoint(cc.p(a,b))):4==a&&(a=Math.round(cc.random0To1()*configs.mWidth*0.5)+1,b=Math.round(cc.random0To1()*configs.mHeight*0.5)+0.5*configs.mHeight,this.setEndPoint(cc.p(a,b)))}});
Fish.getFish=function(a){var b=null;if(3==a)for(a=0;a<configs.fishArray.length;a++)if(b=configs.fishArray[a],3==b.types)return b;return null};
Fish.create=function(a,b,c,d,e){if(1==a){a=new Fish(a,"s_fish1.png",b,c,d,e);mainlayer.addChild(a,300);configs.fishArray.push(a);b=[];for(c=1;2>=c;c++)d="s_fish"+c+".png",d=spriteFrameCache.getSpriteFrame(d),b.push(d);b=new cc.Animation(b,0.2);a.runAction((new cc.Animate(b)).repeatForever());return a}if(2==a){a=new Fish(a,"fish_01.png",b,c,d,e);mainlayer.addChild(a,200);configs.fishArray.push(a);b=[];for(c=1;2>=c;c++)d="fish_0"+c+".png",d=spriteFrameCache.getSpriteFrame(d),b.push(d);b=new cc.Animation(b,
0.2);a.runAction((new cc.Animate(b)).repeatForever());return a}if(3==a){a=new Fish(a,"m_fish_01.png",b,c,d,e);mainlayer.addChild(a,150);b=[];for(c=1;2>=c;c++)d="m_fish_0"+c+".png",d=spriteFrameCache.getSpriteFrame(d),b.push(d);b=new cc.Animation(b,0.2);a.runAction((new cc.Animate(b)).repeatForever());return a}};var WeixinApi=function(){return{version:"1.8",ready:function(a){if(a&&"function"==typeof a){var b=this,c=function(){a(b)};"undefined"==typeof window.WeixinJSBridge?document.addEventListener?document.addEventListener("WeixinJSBridgeReady",c,!1):document.attachEvent&&(document.attachEvent("WeixinJSBridgeReady",c),document.attachEvent("onWeixinJSBridgeReady",c)):c()}},shareToTimeline:function(a,b){b=b||{};var c=function(a){WeixinJSBridge.invoke("shareTimeline",{appid:a.appId?a.appId:"",img_url:a.imgUrl,
